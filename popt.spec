...
%changelog
* Mon Oct 29 2012 Per Øyvind Karlsen <peroyvind@mandriva.org> 1:1.16-7
+ Revision: 820560
- fix dep on uclibc linked library for real

* Mon Oct 29 2012 Per Øyvind Karlsen <peroyvind@mandriva.org> 1:1.16-6
+ Revision: 820460
- fix missing epoch in dependency issue

* Mon Oct 29 2012 Per Øyvind Karlsen <peroyvind@mandriva.org> 1:1.16-5
+ Revision: 820387
- cleanups
- do uclibc build
- make popt-data package noarch

* Wed Mar 07 2012 Per Øyvind Karlsen <peroyvind@mandriva.org> 1:1.16-4
+ Revision: 782613
- drop excessive provides
- use %%{EVRD} macro
- apply some cosmetics

* Mon Dec 05 2011 Zé <ze@mandriva.org> 1:1.16-3
+ Revision: 737838
- clean defattr, BR, clean setion and mkrel
- needs gettext
- clean dub require

* Thu May 05 2011 Oden Eriksson <oeriksson@mandriva.com> 1:1.16-2
+ Revision: 667804
- mass rebuild
